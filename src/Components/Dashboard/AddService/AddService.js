...
const AddService = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch('https://frozen-depths-33463.herokuapp.com/addService', {
      method: 'POST',
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            <div className="card p-4 my-3">
              <h5 className="py-3">Add Product</h5>
              <form className="bg-form" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-3">
                  <label className="form-label h6">Product Title</label>
                  <input
                    type="text"
                    name="name"
                    className="form-control"
                ...
                <div className="mb-3">
                  <label className="form-label h6">Product Cost</label>
                  <input
                    type="number"
                    name="price"
                    className="form-control"
