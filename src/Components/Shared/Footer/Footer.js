        ...
        <footer className="text-lg-start">
            <div className="container p-4">
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h3 className="brand-name "><span className='brand-first'>Electronic</span> <span className='brand-second'>Shop</span></h3>
                    ...
                    <span className='h6'>Email: </span>
                        <a href="#!" className="text-white">mahmud@gmail.com</a>
                    </li>
                    <li className='pt-1'>
                    <span className='h6'>Phone: </span>
                        <a href="#!" className="text-white">01773289420</a>
                    </li>
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h5 className="mt-2 sub-header">Products</h5>

                    <ul className="list-unstyled my-4 ">
                        
                    <li className='pt-1'>
                        <a href="#!" className="text-white">Cameras</a>
                    </li>
                    <li className='pt-1'>
            ...
            <div className="text-center p-3" >
                © 2021 Copyright 
                <a className="text-white" href="#doctor"> Electronic <span className='brand-second'>Shop</span></a>
            </div>
